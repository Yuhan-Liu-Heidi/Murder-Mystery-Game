...
user = {'01': {'pw': '111',
               ...
               'ap': 4,
               'clue': {'p01': [['this is 1/2 clue at p1 ele1',
                                 'this is 2/2 clue at p1 ele1'],
                                ['this is 1/1 clue at p1 ele2']],
                        'p02': [['this is 1/1 clue at p2 ele1'],
...
track = {'chars': {'A': False, 'B': False, 'C': False},
         'publicized_clue': {'p01': [['this is 1/2 clue at p1 ele1'],
                                     ['this is 1/1 clue at p1 ele2']],
                             'p02': [['this is 1/1 clue at p2 ele1']]},
         }

game = {'chars': ['A', 'B', 'C'],
        'clues': {'round1': {'p01': [['clue1 at p1 w/ hidden',
                                      'hidden of clue1 at p1'],
                             # w/ hidden, list with 2 elements
                                     ['clue2 at p1 w/o hidden']],
                             # w/o hidden, list with 1 element
                             'p02': [['clue1 at p2 w/o hidden'],
                                     ['clue2 at p2 w/o hidden']]
                             },
                  'round2': {'p01': [['clue1 at p1 w/ hidden',
                                      'hidden of clue1 at p1'],
                                     ['clue2 at p1 w/o hidden']],
                             'p02': [['clue1 at p2 w/o hidden'],
                                     ['clue2 at p2 w/o hidden']]
